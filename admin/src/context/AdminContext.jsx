...
const AdminContextProvider = (props) => {
    ...
    // Update lab catalog
    const updateLabCatalog = async (categories) => {
        try {
            const { data } = await axios.post(backendUrl + '/api/admin/lab-catalog', { categories }, { headers: { aToken } })
            if (data.success) {
                toast.success(data.message)
                setLabCatalog(categories)
            } else {
    ...
    // Update fees catalog
    const updateFeesCatalog = async (categories) => {
        try {
            const { data } = await axios.post(backendUrl + '/api/admin/fees-catalog', { categories }, { headers: { aToken } })
            if (data.success) {
                toast.success(data.message)
                setFeesCatalog(categories)
            } else {
